...
** https://repository.jboss.org/nexus/content/unzip/unzip/org/jboss/tools/locus/jbosstools-locus/1.7.0/jbosstools-locus-1.7.0-updatesite.zip-unzip/
...
** https://repository.jboss.org/nexus/content/groups/public/org/jboss/tools/locus/jbosstools-locus/1.7.0/jbosstools-locus-1.7.0-updatesite.zip
** https://repository.jboss.org/nexus/content/repositories/snapshots/org/jboss/tools/locus/jbosstools-locus/1.7.0-SNAPSHOT/
...
----
    ...
    # edit ./pom.xml to set the correct version of TARGET_PLATFORM_VERSION = 1.8.0-SNAPSHOT and previousVersion = 1.7.0
	vim ./target-platforms/multiple/locus-multiple.target ./pom.xml
